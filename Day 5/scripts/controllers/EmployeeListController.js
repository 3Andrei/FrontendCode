hrApp.controller('EmployeeListController', ['$scope', '$routeParams', '$http', '$location', 'CommonResourcesFactoryBackup','EmployeeService',
    function ($scope, $routeParams, $http, $location, CommonResourcesFactoryBackup,EmployeeService) {
